...
import { BookOpen, Layers, GraduationCap, Compass, Sparkles, Circle } from 'lucide-react';
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.1rem', flexWrap: 'wrap', gap: '0.5rem' }}>
        ...
        <span className="badge badge-sage" style={{ fontSize: '0.7rem', padding: '0.15rem 0.5rem', borderRadius: 20 }}>
          Interactive Syllabus Hierarchy
        </span>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', position: 'relative' }}>
        ...
        {/* Tier 4: Active Topic Node (HIGHLIGHTED TARGET NODE) */}
        <div style={{ display: 'flex', flexDirection: 'column', paddingLeft: '3.75rem', position: 'relative' }}>
          ...
          <motion.div
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '0.65rem',
              background: 'linear-gradient(135deg, rgba(13, 148, 136, 0.25), rgba(15, 118, 110, 0.2))',
          ...
          >
            <motion.div
              ...
              style={{ width: 24, height: 24, borderRadius: '50%', background: '#2dd4bf', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0f172a', flexShrink: 0 }}
            >
              <Compass size={14} />
            </motion.div>
            <div style={{ flex: 1 }}>
            ...
            <span className="badge badge-sage" style={{ fontSize: '0.65rem', background: '#2dd4bf', color: '#0f172a', fontWeight: 800 }}>
              START HERE
            </span>
          </motion.div>
