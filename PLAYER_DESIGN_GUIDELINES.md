...
This document defines the mandatory UI/UX design standards and architectural guidelines for the interactive player in the Assam Geography Learning Platform (`GEOGRAPHY`).
